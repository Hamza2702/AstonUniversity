...
public class RecipesController {
	private static final Alert ALERT_ARG = new Alert(AlertType.ERROR);
	...
	private static void ALERT(String TITLE, String MESSAGE) {
		ALERT_ARG.setTitle(TITLE);
        ALERT_ARG.setContentText(MESSAGE);
		ALERT_ARG.setHeaderText(null);
        ALERT_ARG.showAndWait();
	}
	...
	protected void doLoad(RecipeFormat fmt, File resultWithExtension) {
		try {
			...
			ALERT("Error loading recipe", e.getMessage());
		}
	}
